...
public class AutomatedTelnetClient implements Runnable, TelnetNotificationHandler
{
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      TerminalTypeOptionHandler ttopt = new TerminalTypeOptionHandler("VT100", false, false, true,
            false);
      ...
      while (true)
      {
         ...
         try
         {
            ...
            Thread reader = new Thread(new AutomatedTelnetClient());
    ...
    *        - type of negotiation command received (RECEIVED_DO, RECEIVED_DONT, RECEIVED_WILL,
    *        RECEIVED_WONT)
    *        <p>
    * @param option_code
